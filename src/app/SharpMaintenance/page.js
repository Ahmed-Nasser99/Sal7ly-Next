    ...
    <main id="maincontent" className="page-main-full-width">
      ...
      <section>
        ...
        <p style={{ textAlign: "right" }}>
          ...
          التكييفات؟ العربى جروب يقدم لكم أفضل خدمات الصيانة والدعم الفني في مصر
          لضمان عمل أجهزتكم بكفاءة عالية.
        </p>
      </section>
      ...
      <section>
        ...
        <p style={{ textAlign: "right" }}>
          نقدم خدمات صيانة لجميع منتجات شارب بما في ذلك أجهزة التبريد، التدفئة،
          الأجهزة الإلكترونية، وغيرها. تواصلوا معنا لحجز موعد الصيانة أو لمعرفة
          المزيد عن خدماتنا.
        </p>
      </section>
      ...
      <section>
        ...
        <p style={{ textAlign: "right" }}>
          يمكنكم حجز موعد الصيانة عن طريق الاتصال بنا على الرقم 19319 أو من خلال
